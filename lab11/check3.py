...
class BallDraw(object):
    def __init__ (self, parent):
        ...
        self.canvas = Canvas(self.top_frame, background="pink", \
    ...
    def restart(self):
        self.isstopped = False
        for n in range(len(self.ball_list)):
            self.ball_list[n].x,self.ball_list[n].y = self.ball_init[n][0],self.ball_init[n][1]
        self.animate()
